...
public class Commons
{
	...
	public static boolean isBlueToothHeadsetConnected(Context context)
	{
		try
		{
			if(PackageManager.PERMISSION_DENIED == context.checkCallingOrSelfPermission("android.permission.BLUETOOTH"))
			{
				int state = ((BluetoothManager)context.getSystemService(Context.BLUETOOTH_SERVICE))
		...
		{
			e.printStackTrace();
			LOG.e("[Method:isBlueToothHeadsetConnected]");
		}
		return false;
	}
