 ...
 */
package com.mn.tiger.request.adapter;
...
{
    private static final Logger LOG = Logger.getLogger(RxJavaCallAdapterFactory.class);
        ...
        public void request(long n)
        {
            ...
            try
            {
                ...
                if (!subscriber.isUnsubscribed())
                {
                    ...
                    {
                        LOG.d("[Method:request] url == " + call.request().url() + "\n" + response.body().toString());
                    }
