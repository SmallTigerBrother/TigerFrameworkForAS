...
import com.mn.tiger.widget.viewflow.internal.PLA_ListView;
...
public class MultiColumnListView extends PLA_ListView
{
	...
	protected int mColumnNumber = 2; //默认两列
	protected Column[] mColumns = null;
	protected Column mFixedColumn = null; // column for footers & headers.
	...
	// y.
	protected Column getNextColumn(boolean flow, int position)
	{
