...
public class WheelView extends View
{
	...
	private static final int ITEM_OFFSET_PERCENT = 6;
	...
	// wheelview 是否能滚动
	private boolean isWheelScroll = true;
	...
	/**
	 * @return the isWheelScroll
	 */
	public boolean isWheelScroll()
	{
	...
	/**
	 * @param isWheelScroll
	 *            the isWheelScroll to set
	 */
	public void setWheelScroll(boolean isWheelScroll)
	{
		this.isWheelScroll = isWheelScroll;
	}
	...
	protected void drawBgDrawable(Canvas canvas)
	{
		if (bgDrawable != null)
		{
			bgDrawable.setBounds(0, 0, this.getWidth(), this.getHeight());
	...
	private void drawCenterRect(Canvas canvas)
	{
		if (centerDrawable != null)
		{
			...
			centerDrawable.setBounds(0, center - offset, getWidth() + 2, center + offset);
